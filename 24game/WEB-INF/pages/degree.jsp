...
<body class="bg">
    ...
    <div id="wrapper">
        ...
        <!-- Page Content -->
       <form name="degree" action="24game" method="get">
                    ...
                    <div class="col-lg-12 col-md-offset-2" style="max-width: 500px;">
                       ...
                       <div style="margin-top: 50px;">
                        ...
                        <div class="col-lg-10 col-md-9 col-md-offset-2">
							<input id="normal" name="normal" type="button" value="normal" class="btn btn-block btn-warning" onclick="getDegree(this.id)" >
                           <input id="hard" name="hard" type="button" value="hard" class="btn btn-block btn-warning" onclick="getDegree(this.id)" >
                           <br>
                           </div></div>
					</div>
				</div>
		...
		<input name="degree" id="degree" type="hidden" value="">
	  </form>
	</div>
	...
	<script>
		...
		{
			if(degree_id == "normal") document.getElementById("degree").value = "normal";
			else document.getElementById("degree").value = "hard";
			document.degree.submit();
		}
	</script>
</body>
